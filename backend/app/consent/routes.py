...
class ConsentRequest(BaseModel):
    ...
    # Defaults to GLOBAL (covers every jurisdiction) - the existing single
    # "grant consent" UI button relies on this default to keep working
    # unchanged; a specific country code here scopes the grant narrower.
