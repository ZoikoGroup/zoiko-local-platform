...
class Plan(Base):
    ...
    #
    # Merge note (2026-08-21): anilupdated independently added this exact
    # same column as `ai_receptionist_minutes_included` - kept this name
    # since it already had wider usage (service/schemas/usage/zoikonex) at
    # merge time; anilupdated's call sites were updated to match.
